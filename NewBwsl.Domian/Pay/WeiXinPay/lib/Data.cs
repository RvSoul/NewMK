...
namespace WxPayAPI
{
    ...
    public class WxPayData
    {
        ...
        /// 业务结果成功
        /// </summary>
        public const string RESULE_SUCCESS = "SUCCESS";

        /// <summary>
        /// 业务结果失败
        /// </summary>
        public const string RESULE_FAIL = "FAIL";
        ...
        */
        ...
        /// 获取返回状态码是否成功
        /// </summary>
        public bool ReturnCodeIsSuceess
        {
            get
            {
                ...
                if (GetValue("return_code").ToString().Equals(RESULE_SUCCESS))
                {
                    return true;
                }
                return false;
        ...
        public string ReturnMsg
        {
            get
            {
                return GetStringValue("return_msg").ToString();
            }
        }
        ...
        /// 获取业务结果是否成功
        /// </summary>
        public bool ResultCodeIsSuceess
        {
            get
            {
                ...
                if (GetValue("result_code").ToString().Equals(RESULE_SUCCESS))
                {
                    return true;
                }
                return false;
        ...
        public string ErrCode
        {
            get
            {
                return GetStringValue("err_code").ToString();
            }
        }
        ...
        public string ErrCodeDes
        {
            get
            {
                return GetStringValue("err_code_des").ToString();
            }
        }
        ...
        public string MchId
        {
            get
            {
                return GetStringValue("mch_id").ToString();
            }
        }
        ...
        public string Appid
        {
            get
            {
                return GetStringValue("appid").ToString();
            }
        }
        ...
        public int TotalFee
        {
            get
            {
                var v = GetStringValue("total_fee").ToString();
        ...
        public string TradeState
        {
            get
            {
                return GetStringValue("trade_state").ToString();
            }
        }
        ...
        public string OutTradeNo
        {
            get
            {
                return GetStringValue("out_trade_no").ToString();
            }
            set
            {
                SetValue("out_trade_no", value);
            }
        }
        ...
        public string TransactionId
        {
            get
            {
                return GetStringValue("transaction_id").ToString();
            }
            set
            {
                SetValue("transaction_id", value);
            }
        }
        #endregion
        ...
        */
        public string ToPrintStr()
        {
            ...
            log.Error("Print in Web Page : " + str);
            return str;
        }
